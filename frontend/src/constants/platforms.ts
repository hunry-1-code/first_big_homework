...
export const PLATFORMS: PlatformInfo[] = [
  ...
  { name: "人民网",   short: "人", color: "#c41e3a", bg: "#fef0f0", api: "新闻爬虫", icon: "https://www.people.com.cn/favicon.ico" },
  { name: "澎湃新闻", short: "澎", color: "#1e40af", bg: "#e8f0fe", api: "新闻爬虫", icon: "https://www.thepaper.cn/favicon.ico" },
  { name: "InfoQ",    short: "Q",  color: "#38a169", bg: "#f0fff4", api: "新闻爬虫", icon: "https://www.infoq.cn/favicon.ico" },
  { name: "少数派",   short: "派", color: "#d53f8c", bg: "#fff5f7", api: "新闻爬虫", icon: "https://sspai.com/favicon.ico" },
